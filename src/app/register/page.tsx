...
export default function RegisterPage() {
  ...
  const handleEmailRegister = async (e: React.FormEvent) => {
    ...
    else router.push("/login?check_email=true");
    setLoading(false);
  };
      ...
      <div className="w-full max-w-sm space-y-6">
        ...
        <div className="space-y-3">
          <button
            ...
            disabled={loading}
            className="flex w-full items-center justify-center gap-2 rounded-lg border border-border px-4 py-2 text-sm font-medium hover:bg-muted transition-colors disabled:opacity-50"
          >
